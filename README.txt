...
Explore the directories on the hosting server.
The table shows the count of all files in the current directory and all the subdirectories.

The DirectoryBrowserApi folder contains the solution for visual studio.
The DirectoryBrowserApi-Release folder contains the released version, which you can run on an IIS server.
...
The API is made to be consumed by the index.htlm page, 
and it is not recommended sending http requests directly.
